...
class HomeTemplate extends BaseTemplate {
    public function getHomeTemplate(): string 
    {
        ...
        <div id="carouselExample" class="carousel slide">
          <div class="carousel-inner">
            ...
            <div class="carousel-item">
              <img src="./img/pechen.webp" class="d-block w-100 h-100" alt="3">
            </div>
            <div class="carousel-item">
              <img src="./img/maslo.jpeg" class="d-block w-100 h-100" alt="2">
            </div>
            <div class="carousel-item">
              <img src="./img/banan.jpeg" class="d-block w-100 h-100" alt="4">
            </div>
            <div class="carousel-item">
              <img src="./img/karri.jpeg" class="d-block w-100 h-100" alt="5">
            </div>
          </div>
        ...
        <div class="row mt-5">
            <p>
                Приветствуем в нашей сети современных блинных ресторанов TRIMM!
            </p>
            <p>
